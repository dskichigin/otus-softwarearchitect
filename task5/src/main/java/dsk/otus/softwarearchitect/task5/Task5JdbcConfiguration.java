package dsk.otus.softwarearchitect.task5;
...
@ComponentScan(basePackages = "dsk.otus.softwarearchitect.task4")
public class Task5JdbcConfiguration extends AbstractJdbcConfiguration {
