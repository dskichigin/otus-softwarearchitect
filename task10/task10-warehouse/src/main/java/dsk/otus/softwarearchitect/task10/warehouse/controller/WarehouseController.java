...
public class WarehouseController {
    ...
    @Counted
    public @ResponseBody
    ResponseEntity<Long> getProduct(@PathVariable("id") String productId, HttpServletRequest request) {
        return ResponseEntity.ok(warehouseCore.getRemains(productId));
    }

    @PutMapping(path="/warehouses/cancel", consumes = "application/json", produces = "application/json")
    @Counted
    public @ResponseBody ResponseEntity cancelOperation(@PathParam("order_id") String orderId, HttpServletRequest request) {
