...
@ComponentScan(basePackages = "dsk.otus.softwarearchitect.task3")
public class Task3JdbcConfiguration extends AbstractJdbcConfiguration {
...
//    @WritingConverter
//    enum DateToDateConverter implements Converter<LocalDate, java.sql.Date> {
//
//        INSTANCE;
//
//        @Override
//        public java.sql.Date convert(LocalDate source) {
